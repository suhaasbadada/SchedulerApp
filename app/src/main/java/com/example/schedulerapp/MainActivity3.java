...
public class MainActivity3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        processid = (EditText) findViewById(R.id.editTextTextPersonName2);
        bursttime = (EditText) findViewById(R.id.editTextTextPersonName3);
        arrivaltime = (EditText) findViewById(R.id.editTextTextPersonName4);
        priority = (EditText) findViewById(R.id.editTextTextPersonName5);
        fetchid = (EditText) findViewById(R.id.editTextTextPersonName6);
        submit = (Button) findViewById(R.id.button7);
        fetch = (Button) findViewById(R.id.button8);
    ...
    void rr(int no,int [] burst,int time_quantum,int [] arr,int [] w,int [] p_id,int [] fla, int [] obt)
    {
        ...
        Toast.makeText(MainActivity3.this, "Average Waiting time ="+awt+"|| Average Turnaround ="+ at, Toast.LENGTH_SHORT).show();
    ...
    void rr2(int no,int [] burst,int time_quantum,int [] arr,int [] w,int [] p_id,int [] fla, int [] obt ,int fid)
    {
        ...
        Toast.makeText(MainActivity3.this, " Waiting time ="+wtt + "|| Turnaround ="+ t+"|| Completion time ="+ctt , Toast.LENGTH_SHORT).show();
