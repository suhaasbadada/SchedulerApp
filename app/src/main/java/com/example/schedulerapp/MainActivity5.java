...
public class MainActivity5 extends AppCompatActivity {
    ...
    EditText n,processid,bursttime,arrivaltime,fetchid;
    Button submit,fetch;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        n =(EditText) findViewById(R.id.editTextTextPersonName19);
        processid = (EditText) findViewById(R.id.editTextTextPersonName20);
        bursttime = (EditText) findViewById(R.id.editTextTextPersonName21);
        arrivaltime = (EditText) findViewById(R.id.editTextTextPersonName17);

        fetchid = (EditText) findViewById(R.id.editTextTextPersonName22);
        submit = (Button) findViewById(R.id.button13);
        fetch = (Button) findViewById(R.id.button14);
    ...
    void rr(int no,int [] burst,int time_quantum,int [] arr,int [] w,int [] p_id,int [] fla, int [] obt )
    {
        ...
        Toast.makeText(MainActivity5.this, "Average Waiting time ="+awt+"|| Average Turnaround ="+ at, Toast.LENGTH_SHORT).show();
    ...
    void rr2(int no,int [] burst,int time_quantum,int [] arr,int [] w,int [] p_id,int [] fla, int [] obt,int fid )
    {
        ...
        Toast.makeText(MainActivity5.this, " Waiting time ="+wtt + " || Turnaround ="+ t+" || Completion time ="+ctt , Toast.LENGTH_SHORT).show();
