...
public class MainActivity4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        n =(EditText) findViewById(R.id.editTextTextPersonName13);
        processid = (EditText) findViewById(R.id.editTextTextPersonName14);
        bursttime = (EditText) findViewById(R.id.editTextTextPersonName15);
        arrivaltime = (EditText) findViewById(R.id.editTextTextPersonName16);

        fetchid = (EditText) findViewById(R.id.editTextTextPersonName18);
        submit = (Button) findViewById(R.id.button11);
        fetch = (Button) findViewById(R.id.button12);
    ...
    void rr(int no,int [] burst,int time_quantum,int [] arr,int [] w,int [] p_id,int [] fla, int [] obt )
    {
        ...
        Toast.makeText(MainActivity4.this, "Average Waiting time ="+awt+"|| Average Turnaround ="+ at, Toast.LENGTH_SHORT).show();
    ...
    void rr2(int no,int [] burst,int time_quantum,int [] arr,int [] w,int [] p_id,int [] fla, int [] obt,int fid )
    {
        ...
        Toast.makeText(MainActivity4.this, " Waiting time ="+wtt + "|| Turnaround ="+ t+"|| Completion time ="+ctt , Toast.LENGTH_SHORT).show();
